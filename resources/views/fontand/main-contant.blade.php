            ...
            <form>
                ...
                <div class="col-12 col-sm-6">
                  <div class="form-group">
                    ...
                    <select wire:model="centerName" id="centerName" name="centerName" class="form-control ">
                      ...
                      <option value="1">মহিলা বিষয়ক অধিদপ্তর</option>
                      <option value="1">জাতীয় মহিলা সংস্থা</option>                      
                    </select>
                  </div>
                </div>
                <div class="col-12 col-sm-6">
                  <div class="form-group">
                   <label for="subcenterName" class="requred-field">জামাদান কেন্দ্র : </label>
                    <select wire:model="subcenterName" id="subcenterName" name="subcenterName" class="form-control ">
                      <option value="" selected>নির্বাচন করুন...</option>
                      <option value="1">জেলা মহিলা বিষয়ক কার্যালয়</option>
                      <option value="2">উপজেলা মহিলা বিষয়ক কার্যালয়</option>  
                      <option value="3">উপজেলা নির্বাহী অফিস</option>  
                      <option value="4">ইউনিয়ন পরিষদ </option>                    
                    </select>
                  </div>
                </div>
              </div>
               <div class="row">
                <div class="col-12 col-sm-6 form-group">
                  ...
                  <select wire:model="district" id="district" name="district" class="form-control ">
                    ...
                    <option value="4">BARGUNA</option>
                    <option value="6">BARISHAL</option>
                    <option value="9">BHOLA</option>
              ...
              <div class="form-group row">
                <div class="col-12 col-sm-6">
                  ...
                  <input type="text" name="name" id="name" placeholder="Enter Your Name" class="form-control " wire:model="name" />
                </div>
                <div class="col-12 col-sm-6">
              ...
              <div class="form-group row">
                <div class="col">
                  ...
                  <select id="costamount" name="costamount" class="form-control " wire:model="costamount">
                    <option selected value="">নির্বাচন করুন...</option>
                    <option value="1">১৫০০০</option>
                    <option value="1">৩০০০০</option>
                    <option value="1">৫০০০০</option>
                    <option value="1">১০০০০০</option>    
                  </select>
                </div>
                <div class="col">
                  ...
                  <select class="form-control" name="sector" class="form-control " wire:model="sector">
                    <option selected value="">নির্বাচন করুন...</option>
                    <option value="1">সেলাই কাজ</option>
                    <option value="1">খামার</option>
                    <option value="1">ক্ষুদ্র শিল্প</option>  
                    <option value="1">হস্ত শিল্প</option>                    
                    <option value="1">অন্যান্য কাজ</option>                                      
                  </select>
                </div>
              </div>
              <div class="form-group">
                <label for="amount">প্রস্তাবিত অর্থের খরচের বিবরণঃ </label>
                <input type="tel" id="amount" name="amount" placeholder="বিবরণ" class="form-control " wire:model="amount" />
              </div>
              ...
              <button wire:click.prevent="store()" class="btn btn-success">আবেদন জমা</button>
